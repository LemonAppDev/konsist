...
class KoStarProjectionForKoSourceSetProviderTest {
    @Test
    ...
    fun `source set name is 'integrationTest' in app module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "appPropertyWithStarProjectionTest" }
            .type
            ?.asGenericTypeDeclaration()
            ?.typeArguments
            ?.firstOrNull()
    ...
    fun `source set name is 'test' in data module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "libPropertyWithStarProjectionTest" }
            .type
            ?.asGenericTypeDeclaration()
            ?.typeArguments
            ?.firstOrNull()
    ...
    fun `source set name is 'main' in root module with double src package`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "rootSrcPropertyWithStarProjection" }
            .type
            ?.asGenericTypeDeclaration()
            ?.typeArguments
            ?.firstOrNull()
