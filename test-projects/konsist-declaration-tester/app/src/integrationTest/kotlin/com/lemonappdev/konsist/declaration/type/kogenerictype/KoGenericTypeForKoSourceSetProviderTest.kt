package com.lemonappdev.konsist.declaration.type.kogenerictype
...
class KoGenericTypeForKoSourceSetProviderTest {
    @Test
    fun `source set name is 'main' in app module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "appPropertyWithGenericType" }
            .type
    ...
    fun `source set name is 'integrationTest' in app module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "appPropertyWithGenericTypeTest" }
            .type
            ?.asGenericTypeDeclaration()
    ...
    fun `source set name is 'main' in data module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "libPropertyWithGenericType" }
            .type
            ?.asGenericTypeDeclaration()
    ...
    fun `source set name is 'test' in data module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "libPropertyWithGenericTypeTest" }
            .type
            ?.asGenericTypeDeclaration()
    ...
    fun `source set name is 'main' in root module`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "rootPropertyWithGenericType" }
            .type
            ?.asGenericTypeDeclaration()
    ...
    fun `source set name is 'main' in root module with double src package`() {
        ...
        val sut = Konsist
            ...
            .properties()
            .first { it.name == "rootSrcPropertyWithGenericType" }
            .type
            ?.asGenericTypeDeclaration()
