...
class DeleteProjectActivityUseCaseTest {
    private val activityRepository: ActivityRepository = mockk()
    private val userRepository: UserRepository = mockk()

    private val sut = DeleteProjectActivityUseCase(
        activityRepository,
        userRepository,
    )
    ...
    fun `returns task activity`() {
        ...
        val expected = ProjectActivity(userId, ProjectActivityType.DELETE, projectId, date)
