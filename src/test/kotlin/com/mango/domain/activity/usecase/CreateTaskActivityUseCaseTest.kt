...
class CreateTaskActivityUseCaseTest {
    private val activityRepository: ActivityRepository = mockk()
    private val userRepository: UserRepository = mockk()

    private val sut = CreateTaskActivityUseCase(
        activityRepository,
        userRepository,
    )
    ...
    fun `returns task activity`() {
        ...
        val expected = TaskActivity(userId, TaskActivityType.CREATE, taskId, date, null, null)
