...
class KoFunctionDeclarationForKoVariableProviderTest {
    ...
    @Test
    fun `function-contains-no-variable-ignore-case`() {
        // given
        val sut =
            getSnippetFile("function-contains-no-variable-ignore-case")
                .functions()
                .first()
    ...
    @Test
    fun `function-contains-variable-ignore-case`() {
        // given
        val sut =
            getSnippetFile("function-contains-variable-ignore-case")
                .functions()
                .first()
