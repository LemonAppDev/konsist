...
class KoInterfaceDeclarationForKoClassAndInterfaceProviderTest {
    ...
    @Test
    fun `interface-has-no-classes-and-interfaces-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-classes-and-interfaces-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-class-and-interface-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-class-and-interface-ignore-case")
                .interfaces()
                .first()
