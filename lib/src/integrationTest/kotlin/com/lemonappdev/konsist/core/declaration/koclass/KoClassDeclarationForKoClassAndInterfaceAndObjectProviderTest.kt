...
class KoClassDeclarationForKoClassAndInterfaceAndObjectProviderTest {
    @Test
    fun `class-has-no-classes-and-interfaces-and-objects`() {
        // given
        val sut =
            getSnippetFile("class-has-no-classes-and-interfaces-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-class-and-interface-and-object`() {
        // given
        val sut =
            getSnippetFile("class-has-class-and-interface-and-object")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal true`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-interfaces-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal false`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-interfaces-and-objects")
                .classes()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal true`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-interfaces-and-objects")
                .classes()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal false`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-interfaces-and-objects")
                .classes()
    ...
    @Test
    fun `class-has-no-classes-and-interfaces-and-objects-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-classes-and-interfaces-and-objects-ignore-case")
                .classes()
                .first()
        ...
        assertSoftly(sut) {
            ...
            hasClassesAndInterfacesAndObjectsWithAllNames("sampleclass1", "sampleinterface", ignoreCase = true) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "sampleinterface")) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "sampleinterface"), ignoreCase = true) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(setOf("sampleclass", "sampleinterface")) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(setOf("sampleclass", "sampleinterface"), ignoreCase = true) shouldBeEqualTo false
        }
    }

    @Test
    fun `class-has-class-and-interface-and-object-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-class-and-interface-and-object-ignore-case")
                .classes()
                .first()
        ...
        assertSoftly(sut) {
            ...
            hasClassOrInterfaceOrObjectWithName(listOf("sampleclass", "otherName"), ignoreCase = true) shouldBeEqualTo true
            ...
            hasClassesAndInterfacesAndObjectsWithAllNames("sampleclass", "sampleinterface") shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames("sampleclass", "sampleinterface", ignoreCase = true) shouldBeEqualTo true
            hasClassesAndInterfacesAndObjectsWithAllNames("sampleclass", "otherclass") shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames("sampleclass", "otherclass", ignoreCase = true) shouldBeEqualTo false
            ...
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "sampleinterface")) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "sampleinterface"), ignoreCase = true) shouldBeEqualTo true
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "otherclass")) shouldBeEqualTo false
            hasClassesAndInterfacesAndObjectsWithAllNames(listOf("sampleclass", "otherclass"), ignoreCase = true) shouldBeEqualTo false
        }
    }

    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/koclass/snippet/forkoclassandinterfaceandobjectprovider/", fileName)
}
