...
class KoPropertyDeclarationForKoTypeParameterProviderTest {
    ...
    @Test
    fun `property-contains-no-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("property-contains-no-type-parameters-ignore-case")
                .properties()
                .first()
    ...
    @Test
    fun `property-contains-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("property-contains-type-parameters-ignore-case")
                .properties()
                .first()
