...
class KoParentDeclarationTest {
    ...
    fun `class-parent-has-to-string`(fileName: String, text: String) {
        // given
        val sut =
    ...
    fun `interface-parent-has-to-string`(fileName: String, text: String) {
        // given
        val sut =
            getSnippetFile(fileName)
                .interfaces()
    ...
    fun `object-parent-has-to-string`(fileName: String, text: String) {
        // given
        val sut =
            getSnippetFile(fileName)
                .objects()
