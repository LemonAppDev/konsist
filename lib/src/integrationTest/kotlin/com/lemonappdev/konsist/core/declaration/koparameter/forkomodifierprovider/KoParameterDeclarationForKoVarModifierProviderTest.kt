...
class KoParameterDeclarationForKoVarModifierProviderTest {
    ...
    fun `parameter-without-var-modifier`() {
        // given
        val sut = getSnippetFile("parameter-without-var-modifier")
            .classes()
            .first()
            .primaryConstructor
            ?.parameters
    ...
    fun `parameter-with-var-modifier`() {
        // given
        val sut = getSnippetFile("parameter-with-var-modifier")
            .classes()
            .first()
            .primaryConstructor
            ?.parameters
    ...
    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/koparameterdeclaration/forkomodifierprovider/snippet/forkovarmodifierprovider/", fileName)
}
