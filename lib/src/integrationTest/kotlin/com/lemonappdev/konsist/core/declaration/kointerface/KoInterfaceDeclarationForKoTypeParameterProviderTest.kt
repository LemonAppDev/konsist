...
class KoInterfaceDeclarationForKoTypeParameterProviderTest {
    ...
    @Test
    fun `interface-contains-no-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-contains-no-type-parameters-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-contains-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-contains-type-parameters-ignore-case")
                .interfaces()
                .first()
