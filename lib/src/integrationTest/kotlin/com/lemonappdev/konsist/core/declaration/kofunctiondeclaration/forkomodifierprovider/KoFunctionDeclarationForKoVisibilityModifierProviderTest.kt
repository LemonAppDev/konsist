...
class KoFunctionDeclarationForKoVisibilityModifierProviderTest {
    ...
    fun `function-without-visibility-modifiers`() {
        // given
        val sut = getSnippetFile("function-without-visibility-modifiers")
            .functions()
            .first()
    ...
    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/kofunctiondeclaration/forkomodifierprovider/snippet/forkovisibilitymodifierprovider/", fileName)
}
