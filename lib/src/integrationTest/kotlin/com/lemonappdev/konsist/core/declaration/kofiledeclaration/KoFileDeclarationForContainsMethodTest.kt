...
class KoFileDeclarationForContainsMethodTest {
    @Test
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/declaration/kofiledeclaration/snippet/forcontainsmethod/", fileName)
}
