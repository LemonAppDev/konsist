...
class KoClassDeclarationForKoParentInterfaceProviderTest {
    ...
    @Test
    fun `class-has-no-parent-interface-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-parent-interface-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-parent-interfaces-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-parent-interfaces-ignore-case")
                .classes()
                .first()
