...
class KoFileForKoFileExtensionProviderTest {
    @Test
    fun `file-extension`() {
        // given
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/container/kofile/snippet/forkofileextensionprovider/", fileName)
}
