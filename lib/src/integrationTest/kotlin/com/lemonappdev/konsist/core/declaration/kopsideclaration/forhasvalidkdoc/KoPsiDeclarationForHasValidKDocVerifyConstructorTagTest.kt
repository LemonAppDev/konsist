...
class KoPsiDeclarationForHasValidKDocVerifyConstructorTagTest {
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope("core/declaration/kopsideclaration/snippet/forhasvalidkdoc/forconstructortag/", fileName)
