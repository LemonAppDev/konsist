...
class KoClassDeclarationForKoInterfaceAndObjectProviderTest {
    @Test
    fun `class-has-no-interfaces-and-objects`() {
        // given
        val sut =
            getSnippetFile("class-has-no-interfaces-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-interface-and-object`() {
        // given
        val sut =
            getSnippetFile("class-has-interface-and-object")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-interfaces-and-objects includeNested true`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-interfaces-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-interfaces-and-objects includeNested false`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-interfaces-and-objects")
                .classes()
    ...
    @Test
    fun `class-has-no-interfaces-and-objects-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-interfaces-and-objects-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-interface-and-object-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-interface-and-object-ignore-case")
                .classes()
                .first()
    ...
    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/koclass/snippet/forkointerfaceandobjectprovider/", fileName)
}
