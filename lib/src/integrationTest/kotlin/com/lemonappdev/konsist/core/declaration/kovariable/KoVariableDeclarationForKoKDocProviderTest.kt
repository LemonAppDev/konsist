...
class KoVariableDeclarationForKoKDocProviderTest {
    ...
    companion object {
        private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/declaration/kovariable/snippet/forkokdocprovider/", fileName)

        @Suppress("unused")
        @JvmStatic
        fun provideValuesForNoKDoc() =
            listOf(
        ...
        @Suppress("unused")
        @JvmStatic
        fun provideValuesForOneLineKDoc() =
            listOf(
