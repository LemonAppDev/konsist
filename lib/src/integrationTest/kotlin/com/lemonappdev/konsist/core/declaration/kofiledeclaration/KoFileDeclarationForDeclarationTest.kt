...
class KoFileDeclarationForDeclarationTest {
    @Test
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/declaration/kofiledeclaration/snippet/fordeclaration/", fileName)
