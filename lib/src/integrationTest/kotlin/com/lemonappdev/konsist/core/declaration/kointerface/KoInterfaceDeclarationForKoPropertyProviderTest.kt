...
class KoInterfaceDeclarationForKoPropertyProviderTest {
    ...
    @Test
    fun `interface-has-no-properties-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-properties-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-properties-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-properties-ignore-case")
                .interfaces()
                .first()
