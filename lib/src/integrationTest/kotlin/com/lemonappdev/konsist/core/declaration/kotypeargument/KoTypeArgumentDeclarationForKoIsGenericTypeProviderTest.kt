...
class KoTypeArgumentDeclarationForKoIsGenericTypeProviderTest {
    @ParameterizedTest
    @MethodSource("provideValues")
    fun `type-argument-is-not-generic-type`(fileName: String) {
        // given
        val sut =
        ...
        // then
        sut?.isGenericType shouldBeEqualTo false
    }
    ...
    fun `generic-type-argument`() {
        ...
        // then
        sut?.isGenericType shouldBeEqualTo true
    }
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope("core/declaration/kotypeargument/snippet/forkoisgenerictypeprovider/", fileName)
