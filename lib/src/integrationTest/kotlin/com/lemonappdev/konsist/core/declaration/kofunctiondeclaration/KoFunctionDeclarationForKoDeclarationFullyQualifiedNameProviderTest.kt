...
class KoFunctionDeclarationForKoDeclarationFullyQualifiedNameProviderTest {
    @Test
    fun `function-fully-qualified-name`() {
        ...
        // then
        sut.fullyQualifiedName shouldBeEqualTo "com.lemonappdev.konsist.testdata.sampleFunction"
    }
