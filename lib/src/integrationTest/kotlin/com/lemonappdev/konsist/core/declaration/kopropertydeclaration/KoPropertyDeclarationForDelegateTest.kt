...
class KoPropertyDeclarationForDelegateTest {
    @Test
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope("core/declaration/kopropertydeclaration/snippet/fordelegate/".toNormalizedPath(), fileName)
}
