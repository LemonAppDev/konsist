...
class KoFileDeclarationForKoClassAndInterfaceAndObjectProviderTest {
    @Test
    fun `file-has-no-classes-and-interfaces-and-objects`() {
        // given
        val sut =
            getSnippetFile("file-has-no-classes-and-interfaces-and-objects")
                .files
                .first()
    ...
    @Test
    fun `file-has-class-and-interface-and-object`() {
        // given
        val sut =
            getSnippetFile("file-has-class-and-interface-and-object")
                .files
                .first()
    ...
    @Test
    fun `file-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal true`() {
        // given
        val sut =
            getSnippetFile("file-contains-nested-and-local-classes-and-interfaces-and-objects")
                .files
                .first()
    ...
    @Test
    fun `file-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal false`() {
        // given
        val sut =
            getSnippetFile("file-contains-nested-and-local-classes-and-interfaces-and-objects")
                .files
    ...
    @Test
    fun `file-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal true`() {
        // given
        val sut =
            getSnippetFile("file-contains-nested-and-local-classes-and-interfaces-and-objects")
                .files
    ...
    @Test
    fun `file-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal false`() {
        // given
        val sut =
            getSnippetFile("file-contains-nested-and-local-classes-and-interfaces-and-objects")
                .files
