...
class KoInterfaceDeclarationForKoClassProviderTest {
    ...
    @Test
    fun `interface-has-no-classes-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-classes-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-classes-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-classes-ignore-case")
                .interfaces()
                .first()
