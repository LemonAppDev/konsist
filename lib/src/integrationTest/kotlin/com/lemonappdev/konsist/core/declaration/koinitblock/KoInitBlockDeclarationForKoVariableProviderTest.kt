...
class KoInitBlockDeclarationForKoVariableProviderTest {
    ...
    @Test
    fun `init-block-contains-no-variable-ignore-case`() {
        // given
        val sut =
            getSnippetFile("init-block-contains-no-variable-ignore-case")
                .classes()
                .initBlocks
                .first()
    ...
    @Test
    fun `init-block-contains-variable-ignore-case`() {
        // given
        val sut =
            getSnippetFile("init-block-contains-variable-ignore-case")
                .classes()
                .initBlocks
                .first()
