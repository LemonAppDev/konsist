...
class KoFileDeclarationForKoFunctionProviderTest {
    ...
    @Test
    fun `file-has-no-functions-ignore-case`() {
        // given
        val sut =
            getSnippetFile("file-has-no-functions-ignore-case")
                .files
                .first()
    ...
    @Test
    fun `file-has-functions-ignore-case`() {
        // given
        val sut =
            getSnippetFile("file-has-functions-ignore-case")
                .files
                .first()
