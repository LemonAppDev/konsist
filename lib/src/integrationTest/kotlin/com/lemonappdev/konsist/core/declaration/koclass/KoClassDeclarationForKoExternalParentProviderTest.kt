...
class KoClassDeclarationForKoExternalParentProviderTest {
    ...
    @Test
    fun `class-has-no-external-parent-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-external-parent-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-external-parents-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-external-parents-ignore-case")
                .classes()
                .first()
