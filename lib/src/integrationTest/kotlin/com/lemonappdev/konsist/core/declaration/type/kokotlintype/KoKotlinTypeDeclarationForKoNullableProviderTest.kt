...
class KoKotlinTypeDeclarationForKoNullableProviderTest {
    @ParameterizedTest
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope("core/declaration/type/kokotlintype/snippet/forkonullableprovider/", fileName)
