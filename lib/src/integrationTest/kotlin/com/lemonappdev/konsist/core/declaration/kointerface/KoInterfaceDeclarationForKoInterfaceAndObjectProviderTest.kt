...
class KoInterfaceDeclarationForKoInterfaceAndObjectProviderTest {
    ...
    @Test
    fun `interface-has-no-interfaces-and-objects-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-interfaces-and-objects-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-interface-and-object-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-interface-and-object-ignore-case")
                .interfaces()
                .first()
