...
class KoClassDeclarationForKoClassAndObjectProviderTest {
    @Test
    fun `class-has-no-classes-and-objects`() {
        // given
        val sut =
            getSnippetFile("class-has-no-classes-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-class-and-object`() {
        // given
        val sut =
            getSnippetFile("class-has-class-and-object")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-objects includeNested true includeLocal true`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-objects")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-objects includeNested true includeLocal false`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-objects")
                .classes()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-objects includeNested false includeLocal true`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-objects")
                .classes()
    ...
    @Test
    fun `class-contains-nested-and-local-classes-and-objects includeNested false includeLocal false`() {
        // given
        val sut =
            getSnippetFile("class-contains-nested-and-local-classes-and-objects")
                .classes()
    ...
    @Test
    fun `class-has-no-classes-and-objects-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-classes-and-objects-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-class-and-object-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-class-and-object-ignore-case")
                .classes()
                .first()
    ...
    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/koclass/snippet/forkoclassandobjectprovider/", fileName)
}
