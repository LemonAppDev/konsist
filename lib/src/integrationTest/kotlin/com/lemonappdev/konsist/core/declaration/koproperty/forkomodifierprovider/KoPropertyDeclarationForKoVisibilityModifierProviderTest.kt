package com.lemonappdev.konsist.core.declaration.koproperty.forkomodifierprovider
...
class KoPropertyDeclarationForKoVisibilityModifierProviderTest {
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope(
            "core/declaration/kopropertydeclaration/forkomodifierprovider/snippet/forkovisibilitymodifierprovider/",
            fileName,
        )
}
