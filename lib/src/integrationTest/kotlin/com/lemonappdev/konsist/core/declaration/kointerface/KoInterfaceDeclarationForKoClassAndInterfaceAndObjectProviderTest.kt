...
class KoInterfaceDeclarationForKoClassAndInterfaceAndObjectProviderTest {
    @Test
    fun `interface-has-no-classes-and-interfaces-and-objects`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-classes-and-interfaces-and-objects")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-class-and-interface-and-object`() {
        // given
        val sut =
            getSnippetFile("interface-has-class-and-interface-and-object")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal true`() {
        // given
        val sut =
            getSnippetFile("interface-contains-nested-and-local-classes-and-interfaces-and-objects")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-contains-nested-and-local-classes-and-interfaces-and-objects includeNested true includeLocal false`() {
        // given
        val sut =
            getSnippetFile("interface-contains-nested-and-local-classes-and-interfaces-and-objects")
                .interfaces()
    ...
    @Test
    fun `interface-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal true`() {
        // given
        val sut =
            getSnippetFile("interface-contains-nested-and-local-classes-and-interfaces-and-objects")
                .interfaces()
    ...
    @Test
    fun `interface-contains-nested-and-local-classes-and-interfaces-and-objects includeNested false includeLocal false`() {
        // given
        val sut =
            getSnippetFile("interface-contains-nested-and-local-classes-and-interfaces-and-objects")
                .interfaces()
    ...
    @Test
    fun `interface-has-no-classes-and-interfaces-and-objects-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-no-classes-and-interfaces-and-objects-ignore-case")
                .interfaces()
                .first()
    ...
    @Test
    fun `interface-has-class-and-interface-and-object-ignore-case`() {
        // given
        val sut =
            getSnippetFile("interface-has-class-and-interface-and-object-ignore-case")
                .interfaces()
                .first()
    ...
    private fun getSnippetFile(fileName: String) =
        getSnippetKoScope("core/declaration/kointerface/snippet/forkoclassandinterfaceandobjectprovider/", fileName)
}
