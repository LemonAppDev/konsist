...
class KoFileForKoImportProviderTest {
    @Test
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/container/kofile/snippet/forkoimportprovider/", fileName)
}
