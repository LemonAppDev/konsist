...
//            hasClassOrInterface { it.hasNameEndingWith("Class") } shouldBeEqualTo false
//            hasClassOrInterface { it.hasNameEndingWith("Class") || it.hasNameEndingWith("Interface")} shouldBeEqualTo false
//            hasAllClassesAndInterfaces { it.hasNameStartingWith("Sample") } shouldBeEqualTo true
...
//        // then
//        assertSoftly(sut) {
//            numClassesAndInterfaces (includeNested = true, includeLocal = true) shouldBeEqualTo 3
//            numClassesAndInterfaces (includeNested = true, includeLocal = false) shouldBeEqualTo 2
...
//            countClassesAndInterfaces  { it.hasPrivateModifier } shouldBeEqualTo 2
