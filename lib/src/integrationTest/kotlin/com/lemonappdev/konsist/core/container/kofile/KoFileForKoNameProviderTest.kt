...
class KoFileForKoNameProviderTest {
    @Test
    fun `file-name`() {
        // given
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/container/kofile/snippet/forkonameprovider/", fileName)
}
