...
class KoTypeArgumentDeclarationForKoTypeArgumentProviderTest {
    ...
    @Test
    fun `out-projection-type-argument-without-type-arguments`() {
        // given
        val sut =
            getSnippetFile("out-projection-type-argument-without-type-arguments")
                .properties()
                .first()
                .type
                ?.typeArguments
    ...
    @Test
    fun `out-projection-type-argument-with-type-arguments`() {
        // given
        val sut =
            getSnippetFile("out-projection-type-argument-with-type-arguments")
                .properties()
                .first()
                .type
                ?.typeArguments
    ...
    @Test
    fun `in-projection-type-argument-without-type-arguments`() {
        // given
        val sut =
            getSnippetFile("in-projection-type-argument-without-type-arguments")
                .properties()
                .first()
                .type
                ?.typeArguments
    ...
    @Test
    fun `in-projection-type-argument-with-type-arguments`() {
        // given
        val sut =
            getSnippetFile("in-projection-type-argument-with-type-arguments")
                .properties()
                .first()
                .type
                ?.typeArguments
