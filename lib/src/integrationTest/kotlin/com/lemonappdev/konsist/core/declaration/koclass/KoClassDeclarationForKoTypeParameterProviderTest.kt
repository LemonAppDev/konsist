...
class KoClassDeclarationForKoTypeParameterProviderTest {
    @Test
    fun `class-contains-no-type-parameters`() {
        // given
        val sut =
            getSnippetFile("class-contains-no-type-parameters")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-one-type-parameter`() {
        // given
        val sut =
            getSnippetFile("class-contains-one-type-parameter")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-two-type-parameters`() {
        // given
        val sut =
            getSnippetFile("class-contains-two-type-parameters")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-no-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-contains-no-type-parameters-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-contains-type-parameters-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-contains-type-parameters-ignore-case")
                .classes()
                .first()
    ...
    private fun getSnippetFile(fileName: String) =
        TestSnippetProvider.getSnippetKoScope("core/declaration/koclass/snippet/forkotypeparameterprovider/", fileName)
}
