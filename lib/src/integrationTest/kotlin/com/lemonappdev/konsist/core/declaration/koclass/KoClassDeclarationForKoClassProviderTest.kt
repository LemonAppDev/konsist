...
class KoClassDeclarationForKoClassProviderTest {
    ...
    @Test
    fun `class-has-no-classes-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-no-classes-ignore-case")
                .classes()
                .first()
    ...
    @Test
    fun `class-has-classes-ignore-case`() {
        // given
        val sut =
            getSnippetFile("class-has-classes-ignore-case")
                .classes()
                .first()
