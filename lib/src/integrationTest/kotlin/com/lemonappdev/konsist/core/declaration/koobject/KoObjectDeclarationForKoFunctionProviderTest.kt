...
class KoObjectDeclarationForKoFunctionProviderTest {
    ...
    fun `contains-functions-with-modifiers`() {
        ...
        assertSoftly(sut) {
            ...
            containsFunction("sampleFunction", INTERNAL, FINAL, includeNested = false, includeLocal = false) shouldBeEqualTo true
            ...
            containsFunction(Regex("[a-zA-Z]+"), INTERNAL, FINAL, includeNested = false, includeLocal = false) shouldBeEqualTo true
