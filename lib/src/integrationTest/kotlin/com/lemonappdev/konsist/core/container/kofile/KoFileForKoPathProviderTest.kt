...
class KoFileForKoPathProviderTest {
    @Test
    fun `file-path`() {
        // given
    ...
    fun `file-project-path`() {
        ...
        sut
            .projectPath
            .shouldBeEqualTo(
                "/lib/src/integrationTest/kotlin/com/lemonappdev/konsist/core/container/kofile/snippet/forkopathprovider/" +
    ...
    private fun getSnippetFile(fileName: String) = getSnippetKoScope("core/container/kofile/snippet/forkopathprovider/", fileName)
}
