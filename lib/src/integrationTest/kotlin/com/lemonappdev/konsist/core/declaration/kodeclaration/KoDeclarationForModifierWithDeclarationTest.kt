...
class KoDeclarationForModifierWithDeclarationTest {
    ...
    companion object {
        ...
        fun provideValuesForDeclarationModifiers() = listOf(
            ...
            arguments("function-has-modifiers-annotation-and-comment", "invoke", listOf(PROTECTED, OPEN)),
            arguments("function-has-modifiers-and-annotations", "invoke", listOf(PROTECTED, OPEN)),
            arguments("function-has-modifiers-and-annotation-with-angle-brackets", "invoke", listOf(PROTECTED, OPEN)),
            ...
            arguments("interface-has-modifiers-annotation-and-comment", "SampleInterface", listOf(PUBLIC, ABSTRACT)),
            arguments("interface-has-modifiers-and-annotations", "SampleInterface", listOf(PUBLIC, ABSTRACT)),
            arguments("interface-has-modifiers-and-annotation-with-angle-brackets", "SampleInterface", listOf(PUBLIC, ABSTRACT)),
            ...
            arguments("object-has-modifiers-annotation-and-comment", "SampleObject", listOf(PRIVATE, DATA)),
            arguments("object-has-modifiers-and-annotations", "SampleObject", listOf(PRIVATE, DATA)),
            arguments("object-has-modifiers-and-annotation-with-angle-brackets", "SampleObject", listOf(PRIVATE, DATA)),
