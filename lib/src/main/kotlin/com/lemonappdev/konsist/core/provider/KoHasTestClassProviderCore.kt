...
@Deprecated("Will be removed in v1.0.0", ReplaceWith("KoTestClassProviderCore"))
internal interface KoHasTestClassProviderCore : KoHasTestClassProvider, KoNameProviderCore, KoBaseProviderCore {
    ...
    override fun hasTestClass(testFileNameSuffix: String, moduleName: String?, sourceSetName: String?): Boolean = Konsist
