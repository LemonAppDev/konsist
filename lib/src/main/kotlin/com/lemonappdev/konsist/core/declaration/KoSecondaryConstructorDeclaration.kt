...
class KoSecondaryConstructorDeclaration private constructor(ktSecondaryConstructor: KtSecondaryConstructor) :
    KoConstructorDeclaration(ktSecondaryConstructor) {
    companion object {
