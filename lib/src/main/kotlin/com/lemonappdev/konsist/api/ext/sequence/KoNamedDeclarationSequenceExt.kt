 ...
 */
fun <T : KoNameProvider> Sequence<T>.withName(name: String, vararg names: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withoutName(name: String, vararg names: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withNameStartingWith(prefix: String, vararg prefixes: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withoutNameStartingWith(prefix: String, vararg prefixes: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withNameEndingWith(suffix: String, vararg suffixes: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withoutNameEndingWith(suffix: String, vararg suffixes: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withNameContaining(text: String, vararg texts: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withoutNameContaining(text: String, vararg texts: String): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withNameMatching(regex: Regex, vararg regexes: Regex): Sequence<T> = filter {
 ...
 */
fun <T : KoNameProvider> Sequence<T>.withoutNameMatching(regex: Regex, vararg regexes: Regex): Sequence<T> = filter {
