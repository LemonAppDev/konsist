 ...
 * @return A sequence containing declarations that have the specified type(s).
 */
 ...
 * @return A sequence containing declarations that don't have the specified type(s).
 */
