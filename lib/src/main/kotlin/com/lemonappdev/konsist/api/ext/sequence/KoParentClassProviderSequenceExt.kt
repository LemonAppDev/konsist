 ...
 */
fun <T : KoParentClassProvider> Sequence<T>.withParentClass(vararg names: String): Sequence<T> = filter {
    when {
 ...
 */
fun <T : KoParentClassProvider> Sequence<T>.withoutParentClass(vararg names: String): Sequence<T> = filter {
    when {
        names.isEmpty() -> !it.hasParentClass()
 ...
 */
inline fun <reified T> Sequence<KoParentClassProvider>.withParentClassOf(): Sequence<KoParentClassProvider> = withParentClassOf(T::class)
 ...
 */
fun <T : KoParentClassProvider> Sequence<T>.withParentClassOf(vararg names: KClass<*>): Sequence<T> = filter {
 ...
 */
fun <T : KoParentClassProvider> Sequence<T>.withoutParentClassOf(vararg names: KClass<*>): Sequence<T> = filter {
