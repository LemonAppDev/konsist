 ...
 */
//inline fun <reified T> representsTypeOf(): Boolean = T::class.qualifiedName == fullyQualifiedName
// ToDo: fix this !!! The uncomment test at KoComplexDeclarationSequenceExt and KoComplexDeclarationExtTest
