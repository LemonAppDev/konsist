 ...
 * @return A list containing declarations with the type of the specified Kotlin class(es).
 */
fun <T : KoNonNullableTypeProvider> List<T>.withTypeOf(kClasses: Set<KClass<*>>): List<T> =
    filter {
        when {
 ...
 * @return A list containing declarations with the type of the specified Kotlin class(es).
 */
fun <T : KoNonNullableTypeProvider> List<T>.withTypeOf(kClasses: List<KClass<*>>): List<T> = withTypeOf(kClasses.toSet())
 ...
 * @return A list containing declarations without type of the specified Kotlin class(es).
 */
fun <T : KoNonNullableTypeProvider> List<T>.withoutTypeOf(kClasses: Set<KClass<*>>): List<T> =
    filterNot {
        when {
            kClasses.isEmpty() -> true
            else -> kClasses.any { kClass -> it.hasTypeOf(kClass) }
 ...
 * @return A list containing declarations without type of the specified Kotlin class(es).
 */
fun <T : KoNonNullableTypeProvider> List<T>.withoutTypeOf(kClasses: List<KClass<*>>): List<T> = withoutTypeOf(kClasses.toSet())
