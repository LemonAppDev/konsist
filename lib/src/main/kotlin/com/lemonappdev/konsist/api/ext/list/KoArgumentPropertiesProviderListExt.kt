 ...
 */
fun <T : KoArgumentPropertiesProvider> List<T>.withArgumentName(name: String, vararg names: String): List<T> = filter {
 ...
 */
fun <T : KoArgumentPropertiesProvider> List<T>.withoutArgumentName(name: String, vararg names: String): List<T> = filter {
 ...
 */
fun <T : KoArgumentPropertiesProvider> List<T>.withValue(value: String, vararg values: String): List<T> = filter {
 ...
 */
fun <T : KoArgumentPropertiesProvider> List<T>.withoutValue(value: String, vararg values: String): List<T> = filter {
