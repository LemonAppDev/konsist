 ...
 */
fun <T : KoLocalFunctionProvider> List<T>.withLocalFunctionNamed(name: String, vararg names: String): List<T> = filter {
 ...
 */
fun <T : KoLocalFunctionProvider> List<T>.withoutLocalFunctionNamed(name: String, vararg names: String): List<T> = filterNot {
    it.hasLocalFunctionWithName(name, *names)
}
 ...
 */
fun <T : KoLocalFunctionProvider> List<T>.withAllLocalFunctionsNamed(name: String, vararg names: String): List<T> = filter {
 ...
 */
fun <T : KoLocalFunctionProvider> List<T>.withLocalFunction(predicate: (KoFunctionDeclaration) -> Boolean): List<T> = filter {
