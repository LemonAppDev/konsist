...
/**
 * List containing declarations that are built-in types. It can be a basic Kotlin type
...
/**
 * List containing declarations that are not built-in types. It cannot be a basic Kotlin type
