...
/**
 * List containing files with any type alias.
 *
 * @return A list containing files with any type alias.
 */
fun <T : KoTypeAliasProvider> List<T>.withTypeAliases(): List<T> = filter { it.hasTypeAliases() }

/**
 * List containing files with all specified type aliases.
 *
 * @param typeAlias The type alias to include.
 * @param typeAliases The type aliases to include.
 * @return A list containing files with all the specified type alias(es).
 */
...
/**
 * List containing files with some type aliases.
 *
 * @param typeAlias The type alias to include.
 * @param typeAliases The type aliases to include.
 * @return A list containing files with at least one of the specified type alias(es).
 */
...
/**
 * List containing files with no type aliases.
 *
 * @return A list containing files with no type aliases.
 */
fun <T : KoTypeAliasProvider> List<T>.withoutTypeAliases(): List<T> = filterNot { it.hasTypeAliases() }

/**
 * List containing files without all the specified type aliases.
 *
 * @param typeAlias The type alias to exclude.
 * @param typeAliases The type aliases to exclude.
 * @return A list containing files without all the specified type alias(es).
 */
...
/**
 * List containing files without some type aliases.
 *
 * @param typeAlias The type alias to exclude.
 * @param typeAliases The type aliases to exclude.
 * @return A list containing files without at least one of the specified type alias(es).
 */
