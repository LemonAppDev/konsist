...
class KoScopeDeclarationOperatorTest {
    ...
    fun `plus operator`() {
        ...
        val scope2 = KoScopeDeclaration
            .fromFile("$testSourceSetPath/lemonappdev/konsist/core/declaration/koscopedeclaration/KoScopeDeclarationForDeclarationTest.kt")
