...
class KoTypeArgumentDeclarationListExtTest {
    ...
    fun `flatten() returns type arguments without nested ones`() {
        ...
        val nestedTypeArgument: KoTypeArgumentDeclaration =
            mockk {
                every { typeArguments } returns null
            }
        ...
        val nestedTypeArgument1: KoTypeArgumentDeclaration =
            mockk {
                every { typeArguments } returns null
            }
        val nestedTypeArgument2: KoTypeArgumentDeclaration =
            mockk {
                every { typeArguments } returns null
            }
        val typeArgument3: KoTypeArgumentDeclaration =
            mockk {
    ...
    fun `flatten() returns type arguments with nested ones`() {
        ...
        val typeArgumentDeclaration1: KoTypeArgumentDeclaration =
            mockk {
        ...
        val typeArgumentDeclaration2: KoTypeArgumentDeclaration =
            mockk {
        ...
        sut shouldBeEqualTo
            listOf(
                typeArgumentDeclaration1,
                typeArgument1,
                typeArgumentDeclaration2,
                typeArgument3,
                typeArgument2,
            )
    }
    ...
    fun `flatten() returns type arguments without nested ones 2`() {
        // given
        val genericType1: KoGenericTypeDeclaration =
            mockk {
        ...
        val genericType2: KoGenericTypeDeclaration =
            mockk {
                every { typeArguments } returns listOf(nestedTypeArgument)
            }
        val nestedTypeArgument1: KoTypeArgumentDeclaration =
        ...
        val genericType3: KoGenericTypeDeclaration =
            mockk {
                every { typeArguments } returns listOf(nestedTypeArgument1, nestedTypeArgument2)
            }
    ...
    fun `flatten() returns type arguments with nested ones 2`() {
        ...
        val genericTypeDeclaration1: KoGenericTypeDeclaration =
            mockk {
                every { typeArguments } returns listOf(typeArgument1)
            }
        val typeArgument2: KoTypeArgumentDeclaration =
        ...
        val genericTypeDeclaration2: KoGenericTypeDeclaration =
            mockk {
                every { typeArguments } returns listOf(typeArgument3)
            }
