...
class TaskEndpointHelper(
    ...
    fun callUpdateEndpoint(requestModel: UpdateTaskRequestModel) =
        controllerEndpointCaller.call<Task>(
            this,
            endpointName = "update",
            method = HttpMethod.POST,
    ...
    fun callAddCommentEndpoint(requestModel: AddCommentRequestModel) =
        controllerEndpointCaller.call<Comment>(
            this,
    ...
    fun callUpdateCommentEndpoint(requestModel: UpdateCommentRequestModel) =
        controllerEndpointCaller.call<Comment>(
            this,
